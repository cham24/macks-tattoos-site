            ...
            <div className="tattoo-aftercare-page">
                ...
                <section className="tattoo-aftercare-content">
                    ...
                    <div className="aftercare-option">
                        <h2>OPTION 2:</h2>
                        <p>
                            If your artist used Tegaderm to cover the tattoo (a breathable adhesive bandage), try to keep the Tegaderm on for up to seven days (please note that it is completely normal for it to fill with black liquid/plasma). Do not submerge it in water for two days (showers are fine). It is also normal for the Tegaderm to start coming off after a few days, so don’t worry if it doesn’t stay on for the full week. You will want to carefully remove the Tegaderm, slowly pulling it away from your skin – do not rip it off. Removing the bandage in the shower will help it come off easier. After the Tegaderm is off, carefully clean the tattoo with a mild unscented antibacterial soap. Follow up with a light layer of lotion or tattoo aftercare.
                        </p>
                    </div>
                    ...
                    <div className="aftercare-contact">
                        <p>
                            If you have any questions or concerns please contact us at <a href="mailto:mackstattoos@gmail.com">mackstattoos@gmail.com</a> or call us at <a href="tel:435-555-5785">435-555-5785</a>. Thank you!
                        </p>
                    </div>
                </section>
            </div>
